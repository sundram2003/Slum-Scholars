...
const PostDetail: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden mx-auto my-8 p-6 w-2/3 flex flex-col">
        ...
        <div className="mt-4 flex-grow">
          ...
          <p className="text-gray-700 text-lg mb-4">{post.fullContent}</p>
